...
**Готово, когда:** полный цикл фичи (создать задачу → назначить оркестратора → наблюдать → ответить на вопрос → принять в done) проходит из браузера, без терминала — кроме самого attach.
